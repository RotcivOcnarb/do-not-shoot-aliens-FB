...
public class PlayerController : MonoBehaviour {
   ...
   public void Die(){
        //Firebase Analytics
        FirebaseAnalytics.LogEvent("player_killed", new Parameter[] {
                new Parameter("game_id", manager.gameId),
                new Parameter("points", targetObject.GetScore()),
                new Parameter("aliens_killed", manager.aliensKilled),
                new Parameter("red_aliens", manager.totalRedAliens),
                new Parameter("time_played", manager.timePlayed)
        });
